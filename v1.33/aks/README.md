...
$ az group create --name aksgroup --location westeurope # create the resource group

$ az aks create -g aksgroup -n aksconformance -k 1.33.2 --node-count 2 --node-vm-size standard_b2ms --generate-ssh-keys # create a single node AKS cluster
